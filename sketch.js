...
function showBoats() {
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      ...
      boats[i].display();
      boats[i].animate();
     //         //Matter.SAT é um módulo que trabalha
// com um teorema do eixo de separação
// para detectar colisão. O Teorema do
// Eixo de Separação (Separating Axis
// Theorem - SAT) afirma que se você pode
// desenhar uma linha para separar dois
// polígonos, eles não irão colidir
